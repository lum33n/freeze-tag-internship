...
\todo[inline]{Je pense que le premier cas devrait être traité avant la
...
En effet, d'après Lemme \ref{worstchord}\todo{Donne le type de proposition que tu
  utilise quand tu y réfère (ex: Lemme, Théorème,.. etc} le pire cas pour $P$ est d'avoir un point le plus loin possible de A et d'avoir des arcs égaux, positionnant donc le dernier point du demi-cercle pile entre le point de $A$ et celui collant $D$. On a alors
$$\gamma(P) \leq \gamma(T, P') = 1 + 2\chord\left(\frac{\pi}{2} -
  \frac{\alpha}{4}\right)$$\todo{Ne pas hésiter à utiliser left et right autour
...
$\gamma(P) \leq 1 + 2\chord(\frac{\pi}{2} - \frac{\alpha}{4})$\todo[inline]{Cela
