...
On a $\gamma\left(P\right) \leq  \gamma\left(T, P\right) \leq \gamma\left(T, P'\right)$
  ...
  \includegraphics[scale=0.4]{2eme_cas}\label{fig:2eme_cas}
...
On prend ensuite le pire cas possible pour ce $T$.
 ...
 \includegraphics[scale=0.4]{3eme_cas1}\label{fig:3eme_cas1}
...
\item \label{3cas12} Si $b$ entre $A$ et $B$ et deux points entre $C$ et $D$,
  ...
  \includegraphics[scale=0.4]{3eme_cas2}\label{fig:3eme_cas2}
...
Considérons $T$ l'arbre représenté Figure~\ref{fig:3eme_cas3}.
 ...
 \includegraphics[scale=0.4]{3eme_cas3}\label{fig:3eme_cas3}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{4eme_cas}\label{fig:4eme_cas}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas1}\label{fig:5eme_cas1}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas1bis}\label{fig:5eme_cas1bis}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas2}\label{fig:5eme_cas2}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas3}\label{fig:5eme_cas3}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas4}\label{fig:5eme_cas4}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{5eme_cas5}\label{fig:5eme_cas5}
%\end{figure}
...
%\begin{figure}[h!]
%  \centering
  \includegraphics[scale=0.4]{n3}\label{fig:n3}
%\end{figure}
